singleton Material("hatch.skin.sparksports")
{
    mapTo = "hatch.skin.sparksports";
    overlayMap[2] = "vehicles/hatch/dpmp_skins/dpmp_sparksports_skin/hatch_skin_sparksports.dds";
