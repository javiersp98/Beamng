...
singleton Material("fullsize.skin.sheriff")
{
    mapTo = "fullsize.skin.sheriff";
    overlayMap[2] = "vehicles/fullsize/dpmp_skins/dpmp_sheriff_skin/fullsize_skin_sheriff.dds";
