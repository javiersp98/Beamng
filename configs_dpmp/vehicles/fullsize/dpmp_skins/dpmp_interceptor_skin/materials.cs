...
singleton Material("fullsize.skin.interceptor")
{
    mapTo = "fullsize.skin.interceptor";
    overlayMap[2] = "vehicles/fullsize/dpmp_skins/dpmp_interceptor_skin/fullsize_skin_interceptor.dds";
