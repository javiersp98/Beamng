...
singleton Material("fullsize.skin.security")
{
    mapTo = "fullsize.skin.security";
    overlayMap[2] = "vehicles/fullsize/dpmp_skins/dpmp_security_skin/fullsize_skin_security.dds";
