singleton Material("pickup.skin.roadservice")
{
    mapTo = "pickup.skin.roadservice";
    overlayMap[2] = "vehicles/pickup/dpmp_skins/dpmp_roadservice_skin/pickup_skin_roadservice.dds";
