...
singleton Material("moonhawk.skin.highway")
{
    mapTo = "moonhawk.skin.highway";
    overlayMap[2] = "vehicles/moonhawk/dpmp_skins/dpmp_highway_skin/moonhawk_skin_highway.dds";
