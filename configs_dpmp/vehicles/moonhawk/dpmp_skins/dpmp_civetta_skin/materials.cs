...
singleton Material("moonhawk.skin.civetta")
{
    mapTo = "moonhawk.skin.civetta";
    overlayMap[2] = "vehicles/moonhawk/dpmp_skins/dpmp_civetta_skin/moonhawk_skin_civetta.dds";
