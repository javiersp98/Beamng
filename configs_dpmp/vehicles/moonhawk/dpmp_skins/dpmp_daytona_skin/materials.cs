...
singleton Material("moonhawk.skin.daytona")
{
    mapTo = "moonhawk.skin.daytona";
    overlayMap[2] = "vehicles/moonhawk/dpmp_skins/dpmp_daytona_skin/moonhawk_skin_daytona.dds";
