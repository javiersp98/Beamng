singleton Material("sunburst.skin.gymkhana")
{
    mapTo = "sunburst.skin.gymkhana";
    overlayMap[2] = "vehicles/sunburst/dpmp_skins/dpmp_gymkhana_skin/sunburst_skin_gymkhana.dds";
