singleton Material("sunburst.skin.diesel2")
{
    mapTo = "sunburst.skin.diesel2";
    overlayMap[2] = "vehicles/sunburst/dpmp_skins/dpmp_diesel2_skin/sunburst_skin_diesel2.dds";
