singleton Material("sunburst.skin.diesel3")
{
    mapTo = "sunburst.skin.diesel3";
    overlayMap[2] = "vehicles/sunburst/dpmp_skins/dpmp_diesel3_skin/sunburst_skin_diesel3.dds";
