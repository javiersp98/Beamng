singleton Material("sunburst.skin.diesel1")
{
    mapTo = "sunburst.skin.diesel1";
    overlayMap[2] = "vehicles/sunburst/dpmp_skins/dpmp_diesel1_skin/sunburst_skin_diesel1.dds";
