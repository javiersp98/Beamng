...
singleton Material("pessima.skin.keisatsu")
{
    mapTo = "pessima.skin.keisatsu";
    //diffuseMap[3] = "vehicles/pessima/pessima_d_dirt.dds";
    overlayMap[2] = "vehicles/pessima/dpmp_skins/dpmp_keisatsu_skin/pessima_skin_keisatsu.png";
