...
singleton Material("pessima.skin.security")
{
    mapTo = "pessima.skin.security";
    overlayMap[2] = "vehicles/pessima/dpmp_skins/dpmp_security_skin/pessima_skin_security.dds";
