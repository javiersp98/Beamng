...
singleton Material("pessima.skin.gendarmerie")
{
    mapTo = "pessima.skin.gendarmerie";
    overlayMap[2] = "vehicles/pessima/dpmp_skins/dpmp_gendarmerie_skin/pessima_skin_gendarmerie.dds";
