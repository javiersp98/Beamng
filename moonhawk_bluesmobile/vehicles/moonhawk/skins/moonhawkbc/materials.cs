singleton Material("moonhawk.skin.moonhawkbc")
{
    mapTo = "moonhawk.skin.moonhawkbc";
    overlayMap[2] = "vehicles/moonhawk/skins/moonhawkbc/skin_moonhawk_bluesmobilec.dds";
