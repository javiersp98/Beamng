singleton Material("hatch.skin.AEPSparkRace")
{
    mapTo = "hatch.skin.AEPSparkRace";
    overlayMap[2] = "vehicles/hatch/AEP_skins/AEP_SparkRace_skin/hatch_AEP_SparkRace_skin.dds";
