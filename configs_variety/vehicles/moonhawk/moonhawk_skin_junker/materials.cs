singleton Material("moonhawk.skin.rustyjunker")
{
    mapTo = "moonhawk.skin.rustyjunker";
    overlayMap[2] = "vehicles/moonhawk/moonhawk_skin_junker/moonhawk_skin_junker.dds";
