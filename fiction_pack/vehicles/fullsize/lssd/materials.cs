singleton Material("fullsize.skin.lssd")
{
    mapTo = "fullsize.skin.lssd";
    overlayMap[2] = "fullsize_skin_lssd.dds";
    diffuseMap[2] = "vehicles/fullsize/fullsize_c_alt.dds";
    specularMap[2] = "vehicles/fullsize/lssd/fullsize_s_alt_n.dds";
    normalMap[2] = "vehicles/fullsize/fullsize_n.dds";
    diffuseMap[1] = "vehicles/fullsize/lssd/fullsize_d_alt_n.dds";
