...
singleton Material("pessima.skin.nbsp")
{
    mapTo = "pessima.skin.nbsp";
    overlayMap[2] = "vehicles/pessima/nbsp/pessima_skin_nbsp.dds";
...
singleton Material("pessima.skin.nbsp2")
{
    mapTo = "pessima.skin.nbsp2";
    overlayMap[2] = "vehicles/pessima/nbsp_skin/pessima_skin_nbsp2.dds";
    diffuseMap[2] = "vehicles/pessima/pessima_c.dds";
    specularMap[2] = "vehicles/pessima/pessima_s.dds";
    normalMap[2] = "vehicles/pessima/pessima_n.dds";
    diffuseMap[1] = "vehicles/pessima/pessima_d.dds";
