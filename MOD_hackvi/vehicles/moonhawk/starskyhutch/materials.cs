singleton Material("moonhawk.skin.starskyhutch")
{
    mapTo = "moonhawk.skin.starskyhutch";
    overlayMap[2] = "vehicles/moonhawk/starskyhutch/moonhawk_skin_starskyhutch.dds";
